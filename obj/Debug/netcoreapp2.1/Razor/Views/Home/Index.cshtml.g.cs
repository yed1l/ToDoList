#pragma checksum "C:\Users\ezhar\Downloads\dotnet_final\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b67ce0597c57895986bf45d41553f082de2b9e81"
// <auto-generated/>
...
#line default
#line hidden
#line 9 "C:\Users\ezhar\Downloads\dotnet_final\Views\Home\Index.cshtml"
using Microsoft.AspNetCore.Identity;

#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b67ce0597c57895986bf45d41553f082de2b9e81", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "C:\Users\ezhar\Downloads\dotnet_final\Views\Home\Index.cshtml"
...
#line hidden
            ...
            WriteLiteral(@"
<div class=""container jumbotron"" style=""background-color:green;"">
    <h1 class=""text-center"" style=""color:white"">TIME MANAGEMENT APPLICATION</h1>
</div>
...
");
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 14 "C:\Users\ezhar\Downloads\dotnet_final\Views\Home\Index.cshtml"
 if (SignInManager.IsSignedIn(User)) { 


#line default
#line hidden
            BeginContext(502, 13508, true);
            WriteLiteral(@"<style>
    body {
        display: felx;
    ...
    .month {
        ...
        font-size: 40px;
        box-shadow: 0px 2px ");
            WriteLiteral(@"6px rgba(21, 21, 21, 0.21);
    }
    ...
    .day {
        ...
        -ms-flex-direction: row;
        flex-direction: row;
        border-bottom: 1px solid rgba(21, 21,");
            WriteLiteral(@" 21, .12);
    ...
    .day.diluted {
        ...
        .day.diluted > span {
            ...
            font-size: 10px;
       ");
            WriteLiteral(@"     color: rgba(21, 21, 21, 0.73);
        }
...
");
    ...
    .list {
        ...
        flex: 1;
        overfl");
            WriteLiteral(@"ow-y: auto !important;
        padding: 0;
        margin: 0;
...
<script src=");
            WriteLiteral("\"//netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js\"></script>\r\n<script src=\"//code.jquery.com/jquery-1.11.1.min.js\"></script>\r\n<!------ Include the above in your HEAD tag ---------->\r\n");
            EndContext();
            BeginContext(14012, 138, true);
            WriteLiteral("<div class=\"wrapper\">\r\n    <div id=\"calendarContainer\"></div>\r\n    <div id=\"organizerContainer\" style=\"margin-left: 8px;\"></div>\r\n</div>\r\n");
            EndContext();
            BeginContext(14152, 24962, true);
            WriteLiteral(@"<script>
    /*
    ...
    */
    ...
    function Calendar(id, size, labelSettings, colors) {
        ...
        for (var i = 0; i < 7; i++)
            this.la");
            WriteLiteral(@"bels.push(this.label[i].substring(0, (labelSettings[1] > 3) ? 3 : labelSettings[1]));
            ...
            if (theNames[i] != ""days"") {
                if (theNames[i] != ""month"") {
                    ...
                    if (theNames[i] != ""labels"") {
                        ...
                        nextSlider.inser");
            WriteLiteral(@"tAdjacentHTML('beforeend', nextSvg);
    ...
    ");
        ...
        for (var i = 0, j = 0; i < 42; i++) {
            ...
            theDays[i].htmlFor =");
            WriteLiteral(@" this.id + ""-day-radio-"" + (i + 1);
    ...
    Organizer.prototype = {
        ...
        back: function (func) {
            ...
            lastDay = new Date");
            WriteLiteral(@"((date.getMonth() + 1 > 11) ? date.getFullYear() + 1 : date.getFullYear(), (date.getMonth() + 1 > 12) ? 0 : date.getMonth() + 1, 0).getDate();
            ...
            if (func == ""day"") {
                ...
                if (func == ""month"") {
                    ...
                    if (date.getMonth() != 0)
                        ...
                        date.setMonth(11);
                        date.setFullYear(date.get");
            WriteLiteral(@"FullYear() - 1);
                    }
                } else
    ...
    Organizer.prototype.draw = function () {
        ...
        backSlider.insertAdjace");
            WriteLiteral(@"ntHTML('beforeend', backSvg);
    ...
    Organizer.prototype.update = function () {
        document.getElementById(this.id + ""-date"").innerHTML = this.calendar.months[this.calendar.date.getMonth()] + "" "" + this.calend");
            WriteLiteral(@"ar.date.getDate() + "", "" + this.calendar.date.getFullYear();
    ...
    Organizer.prototype.setupBlock = function (blockId, theOrganizer, callback) {
      ...
      ");
            WriteLiteral(@"      if (document.getElementById(calendarId + ""-day-num-"" + blockId).innerHTML.length > 0) {
    ...
    Organizer.prototype.setOnClickListener = function (theCase, backCallback, nextCallback) {
        ...
        switch (theCase) {
            ...
            case ""day-slider"":
                ...
                document.getElementById(organizerId + ""-day-next"").");
         ...
         ");
            WriteLiteral(@"           theOrganizer.next('year');
                    nextCallback();
                });
                break;
        }
  ...
  ");
    ...
    function showEvents() {
        ...
        if (theYear == -1) return;
        for (i = 0; i < data.years[theYear].mo");
            WriteLiteral(@"nths.length; i++) {
    ...
    organizer.");
            WriteLiteral(@"setOnClickListener('month-slider', function () { showEvents(); console.log(""Month back slider clicked""); }, function () { showEvents(); console.log(""Month next slider clicked""); });
...
");
            EndContext();
#line 1032 "C:\Users\ezhar\Downloads\dotnet_final\Views\Home\Index.cshtml"
}
